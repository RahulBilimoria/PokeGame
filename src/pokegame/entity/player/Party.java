...
public class Party {
    ...
    public Party(){
        pokemon[0] = new Pokemon(Pokemon.POKEMON_LIST[0], true, false, 1, 1, 1,
                                    11,1,1,1, new Moveset(Move.MOVE_LIST[0]));
        pokemon[1] = new Pokemon(Pokemon.POKEMON_LIST[1], true, false, 2, 8, 7,
                                    2,2,2,2, new Moveset(Move.MOVE_LIST[0], Move.MOVE_LIST[1]));
        pokemon[2] = new Pokemon(Pokemon.POKEMON_LIST[2], true, false, 3, 6, 1,
                                    2,2,2,2, new Moveset(Move.MOVE_LIST[2], Move.MOVE_LIST[3]));
        pokemon[3] = new Pokemon(Pokemon.POKEMON_LIST[3], true, false, 4, 1, 5,
                                    2,2,2,2, new Moveset(Move.MOVE_LIST[4], Move.MOVE_LIST[5]));
        pokemon[4] = new Pokemon(Pokemon.POKEMON_LIST[4], true, false, 5, 2, 2,
                                    2,2,2,2, new Moveset(Move.MOVE_LIST[6], Move.MOVE_LIST[7], Move.MOVE_LIST[8]));
        pokemon[5] = new Pokemon(Pokemon.POKEMON_LIST[5], true, false, 6, 4, 1,
